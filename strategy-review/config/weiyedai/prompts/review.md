...
2. 承接：这条脚本如何把内容兑现成与__AUDIENCE__相关的具体内容？是什么打法（信息差填补/真实经历展开/痛点场景共情/政策翻译/事件关联/缺口补充）？给出可复用的模板。
3. 转折：这条脚本如何从内容自然衔接到产品？是什么打法（痛点求解/标准筛选/质疑反转/叙事延伸/认知翻转/天然关联/政策响应/缺口补充）？给出可复用的转折句式。
4. 角色定位：__BRAND__在这条脚本中扮演什么角色（正规持牌渠道/不押房不押车/凭经营信息申请的周转工具/官方渠道澄清者/小微老板专属方案/利息透明可查/被验证的靠谱/生意应急安全垫）？给出角色名称和典型话术。
